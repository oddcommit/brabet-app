                                ...
                                <div class="list-game-bacarat">
                                    <div class="game-menu">
                                        <template v-for="(nav, index) in navmenu">
                                            <div class="game-menu-item":class="nav.type == selectedGameItem ? 'active' : ''" @click="changeGameItem(nav.type)">
                                                <div>
...
export default {
    ...
    methods: {
        showMore() {
            this.showGameNumber = this.showGameNumber + 6;
        },
        changeGameItem(type) {
            this.showGameNumber = 6;
...
.game-menu-all {
    ...
    // // border-top: 1px solid #00bafe;
    // // border-bottom: 1px solid #00bafe;

    // border-top: 1px solid transparent;
    // border-bottom: 1px solid transparent;
    // border-image:  linear-gradient(90deg, rgba(10,23,57,1) 0%, rgba(0,186,254,1) 50%, rgba(10,23,57,1) 100%);;
