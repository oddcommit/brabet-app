    ...
    <div style="position:  relative;">
        ...
        <div :style="{ display: isShowSlider ? 'block' : 'none' }" class="slider-menu-masking" @click="changeSlider">
            <div class="slider-menu" @click.stop="func1()">
                ...
                <div>
                    <div class="activity" @click="showPage(2)">
                        <img src="../../assets/slider/activity-back.png" />
                        <span>{{ GLOBAL.lanLocal['activity'] }}</span>
                    </div>
                ...
                <!-- <div class="game-slider" @click="showPage(1)">
                    <img src="../../assets/index/game.png" />
                </div>
                <div class="close-slider" @click="changeSlider">
        ...
        <NavHeader v-if="tabIndex != 5 && tabIndex != 51 && tabIndex != 11" @changeSlider="changeSlider"
            ...
            :tabIndex="tabIndex" @change="showPage"></NavHeader>
        ...
        <Tabbar @changeSlider="changeSlider" :accountid="GLOBAL.userInfo.accountid" v-if="tabIndex != 5 && tabIndex != 51" :index="tabIndex" :emailCount="emailCount" @change="showPage">
        </Tabbar>
...
export default {
    ...
    data() {
        return {
            ...
            isForgot: false,
            navmenu : [
                { 'name': "HOT GAME", 'img': require('../../assets/game/HOT GAME.png'), 'type': 0 },
                { 'name': "PG", 'img': require('../../assets/game/PG.png'), 'type': 2 },
                { 'name': 'PP', 'img': require('../../assets/game/PRAGMATIC PLAY.png'), 'type': 3 },
                { 'name': "CURTAM-BET", 'img': require('../../assets/game/OUTRO-BET.png'), 'type': 1 },
            ],
            sourceUrl: '',
        }
    },
